package com.example.compose_dialogs
...
class MainActivity : ComponentActivity() {
    ...
    fun LoginEmailAndPassword(
        ...
        fun visualTransformation() =
            if (isShowPassword.value) VisualTransformation.None else PasswordVisualTransformation()

        fun visualIcon() =
            if (isShowPassword.value) Icons.Filled.Visibility else Icons.Filled.VisibilityOff
